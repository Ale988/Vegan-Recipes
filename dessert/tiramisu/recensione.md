# Recensione — Tiramisù Vegano v1.0.0

**Data:** 2026-04-05
**Commensali:** 9
**Giudizio generale:** Piaciuto a tutti

---

## Note

- I savoiardi avrebbero dovuto essere inzuppati qualche secondo in più nel caffè.
- La dolcezza era leggermente eccessiva secondo 3 commensali su 9 (incluso l'autore).
- Acidità eccessiva (secondo l'autore): non è chiaro se il problema fosse il limone o la panna vegetale, che già dopo la montatura risultava leggermente acida.

---

## Modifiche proposte per la v1.1.0
...
## Risultati decisivi v1.1.0 - v1.2.3

Sia la versione 1.1.0 che la versione 1.2.3 sono piaciute molto ricordando il "vero" tiramisù 